...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 [_LOWER] = LAYOUT(
     ...
     _______,   _______, KC_LBRC, KC_RBRC, S(KC_LBRC), S(KC_RBRC),    KC_1,    KC_2,    KC_3, _______,    _______,   _______,
                                  _______, _______,    _______,       KC_0,    IIDX,    KC_LCTL
 ),
 ...
 [_RAISE] = LAYOUT(
     ...
     _______, KC_F11, KC_F12, _______, _______, _______,       _______, KC_APP,  _______, _______, _______, _______,
                              _______, SDVX,    _______,       _______, _______, _______
 ),

  [_IIDX] = LAYOUT(
      _______, _______, _______, _______, _______, _______,       _______, _______, _______, _______, _______, _______,
      QK_BOOT, _______, _______, _______, _______, _______,       _______, _______, _______, _______, _______, _______,
      _______, _______, _______, KC_CAPS, CW_TOGG, _______,       _______, _______, _______, _______, _______, _______,
